  ...
  @Component({
    selector: 'app-cllanding',
    templateUrl: './cllanding.component.html',
    styleUrls: ['./cllanding.component.scss']
  })
    ...
    onClick(){
      this.http.get(this.url+'/'+this.email+"/")
        ...
        () => {})
          ...
          error => {
            this._ngZone.run(() => this.router.navigate(['register/clreg'], {relativeTo: this.activatedRoute.parent}));
                    }
          )
    }
